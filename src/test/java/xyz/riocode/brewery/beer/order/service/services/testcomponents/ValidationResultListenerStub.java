...
public class ValidationResultListenerStub {
    ...
    public void listen(ValidateBeerOrderEvent event) throws InterruptedException {
        ...
        boolean isValid = event.getBeerOrderDto().getCustomerRef() == null || !event.getBeerOrderDto().getCustomerRef().equals("fail");
        boolean sendResponse = event.getBeerOrderDto().getCustomerRef() == null || !event.getBeerOrderDto().getCustomerRef().equals("dont-validate");
